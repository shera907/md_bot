...
st.set_page_config(page_title="MD_Bot", page_icon=":robot_face:",
...
<div style="text-align: center; padding: 2rem 0;">
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;">🏥 Medical Document Bot</h1>
    <p style="font-size: 1.2rem; color: #666; margin-bottom: 2rem;">Your Intelligent Assistant</p>
</div>
""", unsafe_allow_html=True)
